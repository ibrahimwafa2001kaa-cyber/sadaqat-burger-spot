  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:scale-105 transform shadow-glow transition-bounce font-semibold",
        food: "bg-gradient-food text-white hover:bg-warm-red shadow-warm border-2 border-white/20",
        warm: "bg-warm-orange text-white hover:bg-warm-red shadow-warm",
        gold: "bg-warm-gold text-warm-wood hover:bg-warm-gold/80 shadow-card font-medium",
      },
      size: {
