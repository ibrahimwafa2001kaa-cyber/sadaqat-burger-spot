        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-muted-foreground mb-6 font-persian leading-relaxed">
              رستوران صداقت برگر از سال ۱۳۹۸ با هدف ارائه بهترین برگرهای شهر شروع به کار کرد. 
              ما معتقدیم که طعم واقعی در صداقت و کیفیت مواد اولیه نهفته است.
            </p>
            
            <p className="text-lg text-muted-foreground mb-8 font-persian leading-relaxed">
              با استفاده از گوشت تازه روزانه، نان تازه پخت و سبزیجات ارگانیک، 
              هر برگری که سرو می‌کنیم حاوی عشق و دقت است.
            </p>
